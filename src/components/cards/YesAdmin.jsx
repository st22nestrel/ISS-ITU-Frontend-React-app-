    ...
    card = (
        ...
        <div className="form-inner">
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <label for="description" class="form-label">SI ADMIN!</label>
                        <input type="text" class="form-control" id="description"
                        onChange={e => setDetails({...details, description: e.target.value})} value={details.description}/>
                    </div>

                    <div class="col-12">
                        <label for="field" class="form-label">SI ADMIN!</label>
                        <input type="text" class="form-control" id="description"
                    ...
                    <div class="col-12">
                        <label for="country" class="form-label">SI ADMIN!</label>
                    ...
                    <div class="col-12">
                        <label for="city" class="form-label">SI ADMIN!</label>
                    ...
                    <div class="col-12">
                        <label for="place" class="form-label">SI ADMIN!</label>
